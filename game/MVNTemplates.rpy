...
transform TransRights:
    ...
    u_back_light_color (1.0, 1.0, 0.0, 1.0) # White  
    u_key_light_color (1.0, 1.0, 1.0, 1.0)  # Blue  
    u_fill_light_color (1.0, 1.0, 0.0, 1.0)  # Pink (subtracted from 1)
    u_back_light_direction (1.5, 0.5)
    u_back_light_position (1.0, -0.5)
    u_key_light_position (0.45, 0.2)
    u_key_light_radius (0.5)  
    u_fill_light_direction (1.0, 2.0)  
    u_back_light_intensity (0)          
    u_key_light_intensity (0.3)
    u_fill_light_intensity (-0.3)
transform TransRightswheel:
    shader "MakeVisualNovels.SimulatedLighting"
    u_back_light_color (1.0, 1.0, 0.0, 1.0) # White  
    u_key_light_color (1.0, 1.0, 1.0, 1.0)  # Blue  
    u_fill_light_color (1.0, 1.0, 0.0, 1.0)  # Pink (subtracted from 1)
    ...
    u_fill_light_direction (1.0, 2.0)  
    u_back_light_intensity (0)          
    u_key_light_intensity (0.1)
    u_fill_light_intensity (-0.10)
transform TransRights2:
    shader "MakeVisualNovels.SimulatedLighting"
    u_back_light_color (1.0, 2.0, 3.0) # White  
    u_key_light_color (1.0, 1.0, 1.0, 1.0)  # Blue  
    u_fill_light_color (0.0, 0.2, 0.2)  # Pink (subtracted from 1)
    u_back_light_direction (2.5, -1.5)
    u_back_light_position (2.0, -5.0)
    u_key_light_position (0.40, -0.7)
    u_key_light_radius (6)  
    u_fill_light_direction (-1.0, 0.0)  
    u_back_light_intensity (0.2)          
    u_key_light_intensity (0.2)          
    u_fill_light_intensity (-1.1)
transform TransRightstm:
    shader "MakeVisualNovels.SimulatedLighting"
    u_back_light_color (1.0, 1.0, 1.0) # White  
    u_key_light_color (1.0, 0.5, 0.0, 1.0)  # Blue  
    u_fill_light_color (0, 0.20, 0.2)  # Pink (subtracted from 1)
    u_back_light_direction (1.3, -1.7)
    u_back_light_position (-10.0, -5)
    u_key_light_position (0., 0.5)
    u_key_light_radius (2)  
    u_fill_light_direction (-1.0, 0.0)  
    u_back_light_intensity (0.2)          
    u_key_light_intensity (0.1)          
    u_fill_light_intensity (-0.4)
transform TransRights3:
    shader "MakeVisualNovels.SimulatedLighting"
    u_back_light_color (1.0, 1.0, 1.0) # White  
    u_key_light_color (1.0, 0.5, 0.0, 1.0)   # Blue  
    u_fill_light_color(1.0, 0.5, 0.0, 1.0)   # Pink (subtracted from 1)
    u_back_light_direction (1.3, -0.7)
    u_back_light_position (-5.0, -5)
    u_key_light_position (0., -0.5)
    u_key_light_radius (2)  
    u_fill_light_direction (-1.0, 0.0)  
    u_back_light_intensity (0.0)          
    u_key_light_intensity (0.0)          
    u_fill_light_intensity (-1.3)
